...
The following commands use to configure all the cisco devices for the [Small Office Network](https://github.com/AllanMontalvo/Small-Office-Network) project is listed below.
